...
# img_path = "ImP/imageProcessing/test_files/andrew_iphone_calibration_photo_2.jpg"
...
cv2.imwrite("ImP/output_files/markers.jpg", img)
# img = imp.draw_aerocubes()
# cv2.imwrite("ImP/output_files/markers_w_axes.jpg", img)
